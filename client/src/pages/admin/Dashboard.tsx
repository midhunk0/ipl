        ...
        <>
            <div className="admin-topbar">
                ...
                <ul className="admin-topbar-items">
                    ...
                    <li className={`admin-topbar-item ${active==="playoffs" ? "active" : ""}`} onClick={()=>navigate("/admin/playoffs")}>playoffs</li>
                ...
                <div className="admin-topbar-menu">
                    ...
                    {show && 
                        <ul className="admin-topbar-menu-items">
                            ...
                            <li className={`admin-topbar-item ${active==="playoffs" ? "active" : ""}`} onClick={()=>{ navigate("/admin/playoffs"); setShow(prev=>!prev) }}>playoffs</li>
