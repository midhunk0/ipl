                ...
                {playoffs && (
                    <div className="home-playoffs">
                        <div className="home-q1">
                            <div className={`home-playoff-team ${playoffs.qualifier1.result.won.short!=="" ? playoffs.qualifier1.result.won.short===playoffs.qualifier1.team.short ? "won" : "lost" : ""}`}>
                            ...
                            <div className={`home-playoff-team ${playoffs.qualifier1.result.won.short!=="" ? playoffs.qualifier1.result.won.short===playoffs.qualifier1.opponent.short ? "won" : "lost" : ""}`}>
                        ...
                        <div className="home-el">
                            <div className={`home-playoff-team ${playoffs.eliminator.result.won.short!=="" ? playoffs.eliminator.result.won.short===playoffs.eliminator.team.short ? "won" : "lost" : ""}`}>
                            ...
                            <div className={`home-playoff-team ${playoffs.eliminator.result.won.short!=="" ? playoffs.eliminator.result.won.short===playoffs.eliminator.opponent.short ? "won" : "lost" : ""}`}>
                        ...
                        <div className="home-q2">
                            <div className={`home-playoff-team ${playoffs.qualifier2.result.won.short!=="" ? playoffs.qualifier2.result.won.short===playoffs.qualifier2.team.short ? "won" : "lost" : ""}`}>
                            ...
                            <div className={`home-playoff-team ${playoffs.qualifier2.result.won.short!=="" ? playoffs.qualifier2.result.won.short===playoffs.qualifier2.opponent.short ? "won" : "lost" : ""}`}>
                        ...
                        <div className="home-final">
                            <div className={`home-playoff-team ${playoffs.final.result.won.short!=="" ? playoffs.final.result.won.short===playoffs.final.team.short ? "won" : "lost" : ""}`}>
                            ...
                            <div className="home-final-details" onClick={()=>navigate(`/matches/${season.playoffs.final._id}`)}>
                                <p>final</p>
                                <p>{getFormatedDate(playoffs.final.date)}, {playoffs.final.time}</p>
                                <p>{playoffs.final.venue}</p>
                            </div>
                            <div className={`home-playoff-team ${playoffs.final.result.won.short!=="" ? playoffs.final.result.won.short===playoffs.final.opponent.short ? "won" : "lost" : ""}`}>
